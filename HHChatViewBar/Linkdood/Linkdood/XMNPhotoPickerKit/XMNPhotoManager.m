...
- (void)getAlbumsPickingVideoEnable:(BOOL)pickingVideoEnable
    ...
    if (iOS8Later) {
        ...
        for (PHAssetCollection *collection in smartAlbums) {
            ...
            if (collection.assetCollectionSubtype == 1000000201) continue;//最近删除的不加入
            if (collection.assetCollectionSubtype == PHAssetCollectionSubtypeSmartAlbumUserLibrary) {//默认显示相机胶卷
