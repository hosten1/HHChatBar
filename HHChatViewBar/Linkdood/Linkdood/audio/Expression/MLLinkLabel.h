...
typedef NS_OPTIONS(NSUInteger, MLDataDetectorTypes) {
    ...
    MLDataDetectorTypeAttributedLink = 1 << 26,
};
...
typedef NS_ENUM(NSUInteger, MLLinkType) {
    ...
    MLLinkTypeOther        = 26,          //这个一般是和MLDataDetectorTypeAttributedLink对应的，但是也可以自己随意添加啦，不过是一个标识而已，至于为什么31，随便定的，预留上面空间以添加新的个性化
};

//#define kDefaultLinkColorForMLLinkLabel [UIColor colorWithRed:0.061 green:0.515 blue:0.862 alpha:1.000]
#define kDefaultLinkColorForMLLinkLabel [UIColor blueColor]
