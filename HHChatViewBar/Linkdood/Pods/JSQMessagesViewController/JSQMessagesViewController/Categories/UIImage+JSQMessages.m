...
+ (UIImage *)jsq_defaultAudioImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"audio"];
}

+ (UIImage *)jsq_defaultExpressionImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"expression"];
}
...
+ (UIImage *)jsq_defaultDirectiveImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"directive"];
}

+ (UIImage *)jsq_defaultMoreImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"more"];
}

+ (UIImage *)jsq_defaultSendImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"send"];
}
+ (UIImage *)jsq_defauLeftImage
{
    return [UIImage jsq_bubbleImageFromBundleWithName:@"bubble_left_default"];
}
@end
