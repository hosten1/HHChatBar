...
/**
 *  @return The default photo icon image.
 */
+ (UIImage *)jsq_defaultPhotoImage;

/**
 *  @return The default audio icon image.
 */
+ (UIImage *)jsq_defaultAudioImage;

/**
 *  @return The default expression icon image.
 */
+ (UIImage *)jsq_defaultExpressionImage;

/**
 *  @return The default location icon image.
 */
+ (UIImage *)jsq_defaultLocationImage;

/**
 *  @return The default directive icon image.
 */
+ (UIImage *)jsq_defaultDirectiveImage;

/**
 *  @return The default more icon image.
 */
+ (UIImage *)jsq_defaultMoreImage;

/**
 *  @return The default send icon image.
 */
