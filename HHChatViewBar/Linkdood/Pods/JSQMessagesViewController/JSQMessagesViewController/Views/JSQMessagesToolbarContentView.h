 ...
 */
+ (UINib *)nib;
#pragma extend property
@property (weak, nonatomic) NSArray *extendButtons;
@property (weak, nonatomic, readonly) UIView *extendButtonsContainerView;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *textViewConstraint;
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *extendPanelConstraint;
@property (weak, nonatomic) IBOutlet UIView *extendPanelContainerView;

#pragma mark leftBarButton
@property (weak, nonatomic) UIButton *leftBarButtonItem;

@property (assign,nonatomic) CGFloat leftBarButtonWidth;
