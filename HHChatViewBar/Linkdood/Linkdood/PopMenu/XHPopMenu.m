...
- (UIImageView *)menuContainerView {
    if (!_menuContainerView) {
        ...
        _menuContainerView.frame = CGRectMake(CGRectGetWidth(self.bounds) - kXHMenuTableViewWidth - 10, 67, kXHMenuTableViewWidth, self.menus.count * (kXHMenuItemViewHeight + kXHSeparatorLineImageViewHeight) + kXHMenuTableViewSapcing);
...
- (UITableView *)menuTableView {
    if (!_menuTableView) {
        ...
        _menuTableView.backgroundColor = [UIColor colorWithWhite:0.33 alpha:1];
